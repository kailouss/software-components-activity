...
export const BasicTask: React.FC<BasicTaskProps> = ({
  task,
  onToggleComplete,
  onRemove,
}) => {
  ...
  return (
    <div
      className={`flex w-full justify-between items-center p-4 transition-all border border-l-4 rounded shadow-sm bg-gray-800 relative ${
        task.completed
          ? "bg-gray-50 border-gray-800 opacity-70"
          : "border-gray-300"
      }`}
    >
